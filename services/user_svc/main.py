...
Handles user registration, preferences, and subscription management.
...
app = FastAPI(
    title="RSS Bot User Service",
    description="User profiles and management service",
    version="0.1.0",
)
...
if __name__ == "__main__":
    port = int(os.getenv("USER_SERVICE_PORT", 8008))
    uvicorn.run(
        "main:app",
        host="0.0.0.0",
        port=port,
